    ...
    >
      ...
      <div class="absolute bottom-0 w-full p-4 border-t">
        <div class="flex items-center">
          <img loading="eager"src="https://randomuser.me/api/portraits/men/32.jpg" alt="Admin" class="w-10 h-10 rounded-full">
          <div class="ml-3">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="relative">
              <button class="flex items-center">
                <img loading="eager"src="https://randomuser.me/api/portraits/men/32.jpg" alt="Admin" class="w-8 h-8 rounded-full">
              </button>
            </div>
          </div>
        </div>
              ...
              <div class="p-4">
                ...
                <div class="space-y-3">
                  <div v-for="admin in admins" :key="admin.id" class="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50">
                    <div class="flex items-center">
                      <img loading="eager":src="admin.image" alt="Admin" class="w-8 h-8 rounded-full">
                      <div class="ml-3">
